...
create({N_pipes,Begin_N,End_N},N_pumps,N_hex)->
    supervisor:start_link({local,?MODULE},?MODULE,[{N_pipes,Begin_N,End_N},N_pumps,N_hex]).

init([{_,Begin_N,End_N},N_pumps,N_hex])->
